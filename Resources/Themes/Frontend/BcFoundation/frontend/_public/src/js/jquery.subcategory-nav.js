    ...
    $.plugin('swSubCategoryNav', {
        ...
        addEventListener: function () {
            var me = this,
				...
				console.log(' event listener foundation ');

            // $sidebar.on(me.getEventName(eventName), opts.backwardsSelector, $.proxy(me.onClickBackButton, me));

            $(opts.forwardsSelector).on(me.getEventName(eventName), $.proxy(me.onClickForwardButton, me));
        ...
        onClickForwardButton: function (event) {
			console.dir('fwd2 btn fired: ' + this);
            event.preventDefault();
