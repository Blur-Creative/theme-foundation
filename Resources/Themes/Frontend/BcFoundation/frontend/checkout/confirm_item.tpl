...
{*
	* The following blocks are depracted since Shopware 5.5.1
	* It's moved to checkout/confirm_item_(item_name).tpl
	* Just keep that Code for older Versions
	
	- frontend_checkout_cart_item_tax_price
	- frontend_checkout_cart_item_rebate_tax_price
	- frontend_checkout_cart_item_premium_tax_price
	- frontend_checkout_cart_item_total_sum_tax_price
	- frontend_checkout_cart_item_rebate_total_sum_tax_price
	- frontend_checkout_cart_item_voucher_tax_price
	- frontend_checkout_cart_item_voucher_total_sum_tax_price
*}
...
{* Product tax rate *}
{block name='frontend_checkout_cart_item_total_sum_tax_price'}
